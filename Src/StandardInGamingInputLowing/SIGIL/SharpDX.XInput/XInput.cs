namespace SharpDX.XInput
{
    ...
    internal static class XInput
    {
        ...
        internal delegate Result XInputGetAudioDeviceIdsDelegate(int dwUserIndex, IntPtr renderDeviceId, IntPtr renderCount, IntPtr captureDeviceId, IntPtr pCaptureCount);
        internal delegate Result XInputGetBatteryInformationDelegate(int dwUserIndex, int devType, out BatteryInformation pBatteryInformation);
        internal delegate Result XInputGetCapabilitiesDelegate(int dwUserIndex, int dwFlags, out Capabilities pCapabilities);
        internal delegate Result XInputGetDSoundAudioDeviceGuidsDelegate(int dwUserIndex, out Guid pDSoundRenderGuid, out Guid pDSoundCaptureGuid);
        internal delegate Result XInputGetKeystrokeDelegate(int dwUserIndex, int dwReserved, out Keystroke pKeystroke);
        internal delegate Result XInputGetStateDelegate(int dwUserIndex, out State pState);
        internal delegate Result XInputSetStateDelegate(int dwUserIndex, ref Vibration pVibration);
        ...
        [HandleProcessCorruptedStateExceptions]
        public static unsafe Result XInputGetBatteryInformation(int userIndex, BatteryDeviceType devType, out BatteryInformation batteryInformation)
        {
        ...
        public static unsafe Result XInputGetAudioDeviceIds(int dwUserIndex, IntPtr renderDeviceIdRef, IntPtr renderCountRef, IntPtr captureDeviceIdRef, IntPtr captureCountRef)
        {
            try
            {
        ...
        [HandleProcessCorruptedStateExceptions]
        public static unsafe Result XInputGetCapabilities(int dwUserIndex, DeviceQueryType dwFlags, out Capabilities pCapabilities)
        {
        ...
        [HandleProcessCorruptedStateExceptions]
        public static unsafe Result XInputGetDSoundAudioDeviceGuids(int dwUserIndex, out Guid dSoundRenderGuid, out Guid dSoundCaptureGuid)
        {
        ...
        [HandleProcessCorruptedStateExceptions]
        public static unsafe Result XInputGetKeystroke(int dwUserIndex, int dwReserved, out Keystroke pKeystroke)
        {
        ...
        [HandleProcessCorruptedStateExceptions]
        public static unsafe Result XInputGetState(int dwUserIndex, out State pState)
        {
        ...
        [HandleProcessCorruptedStateExceptions]
        public static unsafe Result XInputSetState(int dwUserIndex, Vibration pVibration)
        {
            try
            {
        ...
        internal delegate Result ResetDelegate();

        /// <summary>Reloads settings from INI file.</summary>
        [HandleProcessCorruptedStateExceptions]
        internal static Result Reset()
        {
