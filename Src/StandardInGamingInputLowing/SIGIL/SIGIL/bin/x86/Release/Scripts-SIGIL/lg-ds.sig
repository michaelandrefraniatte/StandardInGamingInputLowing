    ...
    { 
        ...
        private void task()
        {
            for (; ; )
            {
                if (!running)
                    break;
                valchanged(0, ds.PS5ControllerButtonMenuPressed);
                ...
                if (getstate[0]) 
                {
                    ...
                    mousexp += Math.Round(ds.PS5ControllerGyroX * 65535f / 2f / 1024f * 2f / 5000f, 0);
                    mouseyp += Math.Round(ds.PS5ControllerGyroY * 65535f / 2f / 1024f * 2f / 5000f, 0);
                    if (mousexp >= width / 2f) 
                        mousexp = width / 2f;
                    if (mousexp <= -width / 2f) 
                        mousexp = -width / 2f;
                    ...
                    if (mouseyp <= -height / 2f) 
                        mouseyp = -height / 2f;
                    MouseDesktopX  = width / 2f - mousexp - Math.Round(ds.PS5ControllerGyroX * 65535f / 2f / 1024f * 2f / 5000f, 0);
                    MouseDesktopY  = height / 2f + mouseyp + Math.Round(ds.PS5ControllerGyroY * 65535f / 2f / 1024f * 2f / 5000f, 0);
                    SendD          = ds.PS5ControllerLeftStickX > 0.35f;
                    SendA          = ds.PS5ControllerLeftStickX < -0.35f;
                    SendW          = ds.PS5ControllerLeftStickY > 0.35f;
                    SendS          = ds.PS5ControllerLeftStickY < -0.35f;
                    Send8          = ds.PS5ControllerButtonDPadDownPressed;
                    Send7          = ds.PS5ControllerButtonDPadLeftPressed;
                    Send9          = ds.PS5ControllerButtonDPadRightPressed;
                    Send6          = ds.PS5ControllerButtonDPadUpPressed;
                    SendSpace      = ds.PS5ControllerButtonL1Pressed;
                    SendLeftShift  = ds.PS5ControllerButtonR1Pressed;
                    SendE          = ds.PS5ControllerButtonL3Pressed;
                    SendB          = ds.PS5ControllerButtonR3Pressed;
                    SendR          = ds.PS5ControllerButtonTrianglePressed;
                    SendF          = ds.PS5ControllerButtonSquarePressed;
                    SendX          = ds.PS5ControllerButtonCirclePressed;
                    SendC          = ds.PS5ControllerButtonCrossPressed;
                    SendRightClick = ds.PS5ControllerButtonL2Pressed;
                    SendLeftClick  = ds.PS5ControllerButtonR2Pressed;
                    SendTab        = ds.PS5ControllerButtonLogoPressed;
                    SendEscape     = ds.PS5ControllerButtonTouchpadPressed;
                }
