    ...
    { 
        ...
        private void task()
        {
            for (; ; )
            {
                ...
                Controller_Send_B = ds4.PS4ControllerButtonCrossPressed;
                Controller_Send_A = ds4.PS4ControllerButtonCirclePressed;
                Controller_Send_Y = ds4.PS4ControllerButtonSquarePressed;
                Controller_Send_X = ds4.PS4ControllerButtonTrianglePressed;
