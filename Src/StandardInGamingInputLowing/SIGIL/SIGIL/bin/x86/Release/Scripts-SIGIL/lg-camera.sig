...
namespace StringToCode
{
    ...
    { 
        ...
        public static CameraToLed camera = new CameraToLed();
        ...
        private void task()
        {
            for (; ; )
            {
                if (!running)
                    break;
                MouseDesktopX = width / 2f - camera.camx * width / 2f / 1024f;
                MouseDesktopY = height / 2f + camera.camy * height / 2f / 1024f;
