    ...
    { 
        ...
        private void task()
        {
            for (; ; )
            {
                ...
                controller1_send_A                    = ds.PS5ControllerButtonCrossPressed;
                controller1_send_B                    = ds.PS5ControllerButtonCirclePressed;
                controller1_send_X                    = ds.PS5ControllerButtonSquarePressed;
                controller1_send_Y                    = ds.PS5ControllerButtonTrianglePressed;
                ...
                controller1_send_xbox                 = ds.PS5ControllerButtonMicPressed;
