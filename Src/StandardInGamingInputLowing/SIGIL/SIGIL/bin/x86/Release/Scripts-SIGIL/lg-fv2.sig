        ...
        private void task()
        {
            for (; ; )
            {
                ...
                if (getstate[0]) 
                {
                    ...
                    int_SendD          = di.JoystickAxisX - 65535f / 2f > 32767f / 2f;
                    int_SendQ          = di.JoystickAxisX - 65535f / 2f < -32767f / 2f;
                    int_SendS          = di.JoystickAxisY - 65535f / 2f > 32767f / 2f;
                    int_SendZ          = di.JoystickAxisY - 65535f / 2f < -32767f / 2f;
                    int_SendOne        = di.JoystickPointOfViewControllers0 == 4500 | di.JoystickPointOfViewControllers0 == 0 | di.JoystickPointOfViewControllers0 == 31500;
                    int_SendTwo        = di.JoystickPointOfViewControllers0 == 22500 | di.JoystickPointOfViewControllers0 == 27000 | di.JoystickPointOfViewControllers0 == 31500;
                    int_SendThree      = di.JoystickPointOfViewControllers0 == 22500 | di.JoystickPointOfViewControllers0 == 18000 | di.JoystickPointOfViewControllers0 == 13500;
                    int_SendFour       = di.JoystickPointOfViewControllers0 == 4500 | di.JoystickPointOfViewControllers0 == 9000 | di.JoystickPointOfViewControllers0 == 13500; 
                    int_SendRightClick = di.JoystickButtons9;
                    int_SendLeftClick  = di.JoystickButtons10;
                    int_SendR          = di.JoystickButtons1;
                    int_SendF          = di.JoystickButtons2;
                    int_SendX          = di.JoystickButtons3;
                    int_SendC          = di.JoystickButtons4;
                    int_SendA          = di.JoystickButtons5;
                    int_SendE          = di.JoystickButtons6;
                    int_SendY          = di.JoystickButtons7;
                    int_SendU          = di.JoystickButtons8;
                    int_SendTab        = di.JoystickButtons13;
                    int_SendEscape     = di.JoystickButtons14;
                }
