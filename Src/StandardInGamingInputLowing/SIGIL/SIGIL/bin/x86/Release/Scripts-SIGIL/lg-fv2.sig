        ...
        private void task()
        {
            for (; ; )
            {
                ...
                if (getstate[0]) 
                {
                    ...
                    int_1_SendD          = di.JoystickAxisX - 65535f / 2f > 32767f / 2f;
                    int_1_SendQ          = di.JoystickAxisX - 65535f / 2f < -32767f / 2f;
                    int_1_SendS          = di.JoystickAxisY - 65535f / 2f > 32767f / 2f;
                    int_1_SendZ          = di.JoystickAxisY - 65535f / 2f < -32767f / 2f;
                    int_1_SendOne        = di.JoystickPointOfViewControllers0 == 4500 | di.JoystickPointOfViewControllers0 == 0 | di.JoystickPointOfViewControllers0 == 31500;
                    int_1_SendTwo        = di.JoystickPointOfViewControllers0 == 22500 | di.JoystickPointOfViewControllers0 == 27000 | di.JoystickPointOfViewControllers0 == 31500;
                    int_1_SendThree      = di.JoystickPointOfViewControllers0 == 22500 | di.JoystickPointOfViewControllers0 == 18000 | di.JoystickPointOfViewControllers0 == 13500;
                    int_1_SendFour       = di.JoystickPointOfViewControllers0 == 4500 | di.JoystickPointOfViewControllers0 == 9000 | di.JoystickPointOfViewControllers0 == 13500; 
                    int_1_SendRightClick = di.JoystickButtons9;
                    int_1_SendLeftClick  = di.JoystickButtons10;
                    int_1_SendR          = di.JoystickButtons1;
                    int_1_SendF          = di.JoystickButtons2;
                    int_1_SendX          = di.JoystickButtons3;
                    int_1_SendC          = di.JoystickButtons4;
                    int_1_SendA          = di.JoystickButtons5;
                    int_1_SendE          = di.JoystickButtons6;
                    int_1_SendY          = di.JoystickButtons7;
                    int_1_SendU          = di.JoystickButtons8;
                    int_1_SendTab        = di.JoystickButtons13;
                    int_1_SendEscape     = di.JoystickButtons14;
                }
