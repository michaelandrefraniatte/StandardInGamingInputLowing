...
namespace StringToCode
{
    ...
    { 
        ...
        private static double statex = 0f, statey = 0f, mousex = 0f, mousey = 0f, mousexp = 0f, mouseyp = 0f, mousestatex = 0f, mousestatey = 0f, dzx = 0.0f, dzy = 0.0f, viewpower1x = 1f, viewpower2x = 0f, viewpower3x = 0f, viewpower1y = 1f, viewpower2y = 0f, viewpower3y = 0f, viewpower05x = 0f, viewpower05y = 0f;
        private static bool[] getstate = new bool[12];
        private static int sleeptime = 12;
        ...
        private void task()
        {
            for (; ; )
            {
                ...
                if (getstate[0]) 
                {
                    ...
                    int_1_SendC         = wm.WiimoteButtonStateDown; /* Relacher */
