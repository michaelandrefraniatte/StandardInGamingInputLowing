...
using MouseRawHooksAPI;
using KeyboardRawHooksAPI;
namespace StringToCode
{
    ...
    { 
        ...
        private static MouseRawHook mrh = new MouseRawHook();
        private static KeyboardRawHook krh = new KeyboardRawHook();
        ...
        private void task()
        {
            for (; ; )
            {
                ...
                if (getstate[0])
                {
                    statex = -mrh.MouseAxisX * 50f;
                    statey = mrh.MouseAxisY * 50f;
                    if (statex >= 1024f)
                        statex = 1024f;
                    if (statex <= -1024f)
                        statex = -1024f;
                    ...
                    Controller_Send_left                 = krh.Key_Z;
                    Controller_Send_right                = krh.Key_V;
                    Controller_Send_down                 = krh.Key_C;
                    Controller_Send_up                   = krh.Key_X;
                    Controller_Send_rightstick           = krh.Key_E;
                    Controller_Send_leftstick            = krh.Key_LeftShift;
                    Controller_Send_A                    = krh.Key_Space;
                    Controller_Send_back                 = krh.Key_Tab;
                    Controller_Send_start                = krh.Key_Escape;
                    Controller_Send_X                    = krh.Key_R | mrh.MouseButtons3;
                    Controller_Send_rightbumper          = krh.Key_G | mrh.MouseAxisZ == 128 | mrh.MouseAxisZ == -128;
                    Controller_Send_leftbumper           = krh.Key_T;
                    Controller_Send_B                    = krh.Key_LeftControl | krh.Key_Q;
                    Controller_Send_Y                    = mrh.MouseAxisZ > 0 | mrh.MouseAxisZ < 0;
                    Controller_Send_righttriggerposition = mrh.MouseButtons0 ? 255 : 0;
                    if (krh.Key_W)
                        Controller_Send_leftsticky = 32767;
                    if (krh.Key_S)
                        Controller_Send_leftsticky = -32767;
                    if ((!krh.Key_W & !krh.Key_S) | (krh.Key_W & krh.Key_S))
                        Controller_Send_leftsticky = 0;
                    if (krh.Key_D)
                        Controller_Send_leftstickx = 32767;
                    if (krh.Key_A)
                        Controller_Send_leftstickx = -32767;
                    if ((!krh.Key_D & !krh.Key_A) | (krh.Key_D & krh.Key_A))
                        Controller_Send_leftstickx = 0;
                    valchanged(1, mrh.MouseButtons2);
