    ...
    { 
        ...
        private void task()
        {
            for (; ; )
            {
                ...
                controller1_send_A                    = ds4.PS4ControllerButtonCrossPressed;
                controller1_send_B                    = ds4.PS4ControllerButtonCirclePressed;
                controller1_send_X                    = ds4.PS4ControllerButtonSquarePressed;
                controller1_send_Y                    = ds4.PS4ControllerButtonTrianglePressed;
                ...
                controller1_send_xbox                 = ds4.PS4ControllerButtonMicPressed;
