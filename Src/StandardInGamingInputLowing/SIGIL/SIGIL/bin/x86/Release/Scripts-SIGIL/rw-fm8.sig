...
namespace StringToCode
{
    ...
    { 
        ...
        private WiiMoteLibMP wm = new WiiMoteLibMP();
        ...
        private void task()
        {
            for (; ; )
            {
                ...
                Controller_Send_leftbumper  = countleftbumper > 0;
                Controller_Send_rightbumper = countrightbumperleftbumper > 300;
                ...
                Controller_Send_back  = countback > 0;
                Controller_Send_start = countstartback > 300;
