    ...
    { 
        ...
        private void task()
        {
            for (; ; )
            {
                ...
                controller1_send_rightstick           = jl.JoyconLeftAccelY <= -1.13;
                controller1_send_leftstick            = jl.JoyconLeftButtonSHOULDER_2;
                controller1_send_A                    = jl.JoyconLeftButtonSHOULDER_1;
