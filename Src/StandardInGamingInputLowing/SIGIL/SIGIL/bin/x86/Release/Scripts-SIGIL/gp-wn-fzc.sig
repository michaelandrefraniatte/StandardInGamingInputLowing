...
dzx                           = 3f;
dzy                           = 3f;
controller1_send_rightstick   = WiimoteButtonStateDown;
...
controller1_send_B            = WiimoteButtonStateRight;
controller1_send_Y            = WiimoteNunchuckStateRawValuesY > 90f | WiimoteButtonStateUp;
