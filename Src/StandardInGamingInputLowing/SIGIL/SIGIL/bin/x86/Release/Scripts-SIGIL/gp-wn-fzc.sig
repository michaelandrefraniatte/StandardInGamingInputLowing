    ...
    { 
        ...
        private void task()
        {
            for (; ; )
            {
                if (!running)
                    break;
                controller1_send_rightstick           = wm.WiimoteButtonStateDown;
                ...
                controller1_send_B                    = wm.WiimoteButtonStateRight;
                controller1_send_Y                    = wm.WiimoteNunchuckStateRawValuesY > 90f | wm.WiimoteButtonStateUp;
                controller1_send_righttriggerposition = wm.WiimoteButtonStateB ? 255 : 0;
                controller1_send_lefttriggerposition  = wm.WiimoteButtonStateA ? 255 : 0;
