...
if (getstate[0]) 
{
    ...
    SendD          = WiimoteNunchuckStateRawJoystickX >= 42f;
    SendQ          = WiimoteNunchuckStateRawJoystickX <= -42f;
    SendZ          = WiimoteNunchuckStateRawJoystickY >= 42f;
    SendS          = WiimoteNunchuckStateRawJoystickY <= -42f;
