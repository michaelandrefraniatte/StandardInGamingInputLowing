    ...
    { 
        ...
        private void task()
        {
            for (; ; )
            {
                if (!running)
                    break;
                valchanged(0, jr.JoyconRightButtonHOME);
                ...
                if (getstate[0]) 
                {
                    ...
                    SendD          = jr.JoyconRightStickX > 0.35f;
                    SendQ          = jr.JoyconRightStickX < -0.35f;
                    SendZ          = jr.JoyconRightStickY > 0.35f;
                    SendS          = jr.JoyconRightStickY < -0.35f;
                    Send1          = jr.JoyconRightButtonDPAD_UP;
                    Send2          = jr.JoyconRightButtonDPAD_LEFT;
                    Send3          = jr.JoyconRightButtonDPAD_DOWN;
                    Send4          = jr.JoyconRightButtonDPAD_RIGHT;
                    SendSpace      = jr.JoyconRightButtonSHOULDER_1;
                    SendLeftShift  = jr.JoyconRightButtonSHOULDER_2 | jr.JoyconRightButtonSTICK;
                    SendE          = jr.JoyconRightButtonSR;
                    SendA          = jr.JoyconRightButtonSL;
                    SendV          = jr.JoyconRightButtonPLUS;
                    SendEscape     = wm.WiimoteButtonStateTwo;
                    SendTab        = wm.WiimoteButtonStateOne;
                    SendR          = ((wm.WiimoteRawValuesZ > 0 ? wm.WiimoteRawValuesZ : -wm.WiimoteRawValuesZ) >= 30f & (wm.WiimoteRawValuesY > 0 ? wm.WiimoteRawValuesY : -wm.WiimoteRawValuesY) >= 30f & (wm.WiimoteRawValuesX > 0 ? wm.WiimoteRawValuesX : -wm.WiimoteRawValuesX) >= 30f);
                    SendF          = wm.WiimoteButtonStateHome;
                    SendT          = wm.WiimoteButtonStateMinus;
                    SendG          = wm.WiimoteButtonStatePlus;
                    SendY          = wm.WiimoteButtonStateLeft;
                    SendU          = wm.WiimoteButtonStateRight;
                    SendX          = wm.WiimoteButtonStateUp;
                    SendC          = wm.WiimoteButtonStateDown;
                    SendRightClick = wm.WiimoteButtonStateA;
                    SendLeftClick  = wm.WiimoteButtonStateB;
                }
