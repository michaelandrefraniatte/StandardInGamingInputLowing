    ...
    { 
        ...
        private void task()
        {
            for (; ; )
            {
                if (!running)
                    break;
                valchanged(0, jl.JoyconLeftButtonCAPTURE);
                ...
                if (getstate[0]) 
                {
                    ...
                    SendD          = jl.JoyconLeftStickX > 0.35f;
                    SendQ          = jl.JoyconLeftStickX < -0.35f;
                    SendZ          = jl.JoyconLeftStickY > 0.35f;
                    SendS          = jl.JoyconLeftStickY < -0.35f;
                    Send1          = jl.JoyconLeftButtonDPAD_UP;
                    Send2          = jl.JoyconLeftButtonDPAD_LEFT;
                    Send3          = jl.JoyconLeftButtonDPAD_DOWN;
                    Send4          = jl.JoyconLeftButtonDPAD_RIGHT;
                    SendSpace      = jl.JoyconLeftButtonSHOULDER_1;
                    SendLeftShift  = jl.JoyconLeftButtonSHOULDER_2 | jl.JoyconLeftButtonSTICK;
                    SendE          = jl.JoyconLeftButtonSR;
                    SendA          = jl.JoyconLeftButtonSL;
                    SendV          = jl.JoyconLeftButtonMINUS;
