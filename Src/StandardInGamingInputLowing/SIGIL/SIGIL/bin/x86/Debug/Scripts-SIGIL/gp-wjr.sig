    ...
    { 
        ...
        private void task()
        {
            for (; ; )
            {
                if (!running)
                    break;
                Controller_Send_down                 = jr.JoyconRightButtonDPAD_DOWN;
                Controller_Send_left                 = jr.JoyconRightButtonDPAD_LEFT;
                Controller_Send_right                = jr.JoyconRightButtonDPAD_RIGHT;
                Controller_Send_up                   = jr.JoyconRightButtonDPAD_UP;
                Controller_Send_rightstick           = jr.JoyconRightAccelY <= -1.13;
                Controller_Send_leftstick            = jr.JoyconRightButtonSHOULDER_2;
                Controller_Send_A                    = jr.JoyconRightButtonSHOULDER_1;
