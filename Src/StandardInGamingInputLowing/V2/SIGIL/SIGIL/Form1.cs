    ...
    public partial class Form1 : Form
    {
        ...
        private void ChangeScriptColors(object sender)
        {
            try
            {
                ...
                range.SetStyle(StyleLibrary, new Regex(@"valListX"));
                range.SetStyle(StyleLibrary, new Regex(@"valListY"));
                range.SetStyle(StyleLibrary, new Regex(@"Count"));
                range.SetStyle(StyleLibrary, new Regex(@"Clear"));
                range.SetStyle(StyleLibrary, new Regex(@"RemoveAt"));
                range.SetStyle(StyleLibrary, new Regex(@"Add"));
                range.SetStyle(StyleLibrary, new Regex(@"Average"));
                range.SetStyle(StyleLibrary, new Regex(@"Count"));
                range.SetStyle(StyleLibrary, new Regex(@"Clear"));
                range.SetStyle(StyleLibrary, new Regex(@"RemoveAt"));
                range.SetStyle(StyleLibrary, new Regex(@"Add"));
                ...
                range.SetStyle(StyleLibrary, new Regex(@"System.Windows.Forms.Screen.PrimaryScreen.Bounds.Width"));
                range.SetStyle(StyleLibrary, new Regex(@"System.Windows.Forms.Screen.PrimaryScreen.Bounds.Height"));
                range.SetStyle(StyleLibrary, new Regex(@"Math"));
                range.SetStyle(StyleLibrary, new Regex(@"Abs"));
                range.SetStyle(StyleLibrary, new Regex(@"Sign"));
                range.SetStyle(StyleLibrary, new Regex(@"Round"));
                range.SetStyle(StyleLibrary, new Regex(@"Pow"));
                range.SetStyle(StyleLibrary, new Regex(@"Sqrt"));
                range.SetStyle(StyleLibrary, new Regex(@"Log"));
                range.SetStyle(StyleLibrary, new Regex(@"Exp"));
                range.SetStyle(StyleLibrary, new Regex(@"Min"));
                range.SetStyle(StyleLibrary, new Regex(@"Max"));
                range.SetStyle(StyleLibrary, new Regex(@"Floor"));
                range.SetStyle(StyleLibrary, new Regex(@"Truncate"));
                ...
                range.SetStyle(StyleMethod, new Regex(@"Scale"));
