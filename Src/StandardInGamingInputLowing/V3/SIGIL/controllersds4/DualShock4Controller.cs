...
namespace controllersds4
{
    ...
    {
        private static List<DualShock4Button> ButtonMap = new List<DualShock4Button>()
    {
        ...
        private static List<DualShock4Axis> AxisMap = new List<DualShock4Axis>()
    {
        DualShock4Axis.LeftThumbX, DualShock4Axis.LeftThumbY, DualShock4Axis.RightThumbX, DualShock4Axis.RightThumbY
    };

        private static List<DualShock4Slider> SliderMap = new List<DualShock4Slider>()
    {
