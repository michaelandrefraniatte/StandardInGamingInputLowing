...
{
    public class WiiMoteLibMP : IDisposable
    {
        ...
        private void taskD()
        {
            for (; ; )
            {
                ...
                if (formvisible)
                {
                    ...
                    str += "WiimoteMotionPlusStateRawX : " + WiimoteMotionPlusStateRawX + Environment.NewLine;
                    str += "WiimoteMotionPlusStateRawY : " + WiimoteMotionPlusStateRawY + Environment.NewLine;
                    str += "WiimoteMotionPlusStateRawZ : " + WiimoteMotionPlusStateRawZ + Environment.NewLine;
                    str += "WiimoteMotionPlusStatePitchFast : " + WiimoteMotionPlusStatePitchFast + Environment.NewLine;
                    str += "WiimoteMotionPlusStateRollFast : " + WiimoteMotionPlusStateRollFast + Environment.NewLine;
                    str += "WiimoteMotionPlusStateYawFast : " + WiimoteMotionPlusStateYawFast + Environment.NewLine;
                    str += "WiimoteTaikoDrumStateInnerLeft : " + WiimoteTaikoDrumStateInnerLeft + Environment.NewLine;
        ...
        private void wm_WiimoteChanged(object sender, WiimoteChangedEventArgs e)
        {
            ...
            if (e.WiimoteState.ExtensionType == ExtensionType.Nunchuk)
            {
            ...
            if (e.WiimoteState.ExtensionType == ExtensionType.ClassicController)
            {
            ...
            if (e.WiimoteState.ExtensionType == ExtensionType.MotionPlus)
            {
                WiimoteMotionPlusStateRawX = e.WiimoteState.MotionPlusState.RawValues.X;
                WiimoteMotionPlusStateRawY = e.WiimoteState.MotionPlusState.RawValues.Y;
                WiimoteMotionPlusStateRawZ = e.WiimoteState.MotionPlusState.RawValues.Z;
                WiimoteMotionPlusStatePitchFast = e.WiimoteState.MotionPlusState.PitchFast;
                WiimoteMotionPlusStateRollFast = e.WiimoteState.MotionPlusState.RollFast;
                WiimoteMotionPlusStateYawFast = e.WiimoteState.MotionPlusState.YawFast;
            }
            if (e.WiimoteState.ExtensionType == ExtensionType.TaikoDrum)
            {
                WiimoteTaikoDrumStateInnerLeft = e.WiimoteState.TaikoDrumState.InnerLeft;
                WiimoteTaikoDrumStateOuterLeft = e.WiimoteState.TaikoDrumState.OuterLeft;
                WiimoteTaikoDrumStateInnerRight = e.WiimoteState.TaikoDrumState.InnerRight;
                WiimoteTaikoDrumStateOuterRight = e.WiimoteState.TaikoDrumState.OuterRight;
            }
        }
