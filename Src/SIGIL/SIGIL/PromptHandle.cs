...
namespace SIGIL
{
    public partial class PromptHandle : Form
    {
        public PromptHandle()
        {
            InitializeComponent();
        }
        private static PromptHandle prompt = new PromptHandle();
        private void PromptHandle_Load(object sender, EventArgs e)
        {
        }
        private void PromptHandle_KeyDown(object sender, KeyEventArgs e)
        {
            OnKeyDown(e.KeyData);
        }
