        ...
        private void task()
        {
            for (; ; )
            {
                ...
                if (getstate[0]) 
                {
                    ...
                    mousexp += Math.Round(jl.JoyconLeftGyroX * width / 2f / 1024f * 2f / 200f, 0) * 1f;
                    mouseyp += Math.Round(jl.JoyconLeftGyroY * height / 2f / 1024f * 2f / 200f, 0) * 1f;
                    if (mousexp >= width / 2f) 
                        mousexp = width / 2f;
                    if (mousexp <= -width / 2f) 
                        mousexp = -width / 2f;
                    ...
                    if (mouseyp <= -height / 2f) 
                        mouseyp = -height / 2f;
                    MouseDesktopX = width / 2f - mousexp - Math.Round(jl.JoyconLeftGyroX * width / 2f / 1024f * 2f / 200f, 0) * 1f;
                    MouseDesktopY = height / 2f + mouseyp + Math.Round(jl.JoyconLeftGyroY * height / 2f / 1024f * 2f / 200f, 0) * 1f;
