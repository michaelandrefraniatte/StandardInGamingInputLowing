...
namespace SIGIL
{
    public partial class Form18 : Form
    {
        ...
        private void Form18_Shown(object sender, EventArgs e)
        {
            ...
            virtualkeyboard = Image.FromFile(Application.StartupPath + @"\virtualkeyboard.png") as Bitmap;
            this.BackgroundImage = virtualkeyboard;
            this.pictureBox1.BackgroundImage = virtualkeyboard;
            pressed = Image.FromFile(Application.StartupPath + @"\pressed.png") as Bitmap;
            pressed.MakeTransparent(Color.White);
            image = pressed;
        ...
        private void Form18_KeyDown(object sender, KeyEventArgs e)
        {
            OnKeyDown(e.KeyData);
        }
