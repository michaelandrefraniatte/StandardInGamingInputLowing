...
namespace DualShocks4ProAPI
{
    public class DualShock4Pro : IDisposable
    {
        ...
        private void taskD()
        {
            for (; ; )
            {
                ...
                try
                {
                    ReadFile(handle, ds4data, 64, out BytesRead, IntPtr.Zero);
